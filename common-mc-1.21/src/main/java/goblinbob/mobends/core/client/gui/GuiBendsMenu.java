...
public class GuiBendsMenu extends Screen
{
	...
	private static final ResourceLocation MENU_TITLE_TEXTURE = ModStatics.getResource(
			"textures/gui/title.png");
	public static final ResourceLocation ICONS_TEXTURE = ModStatics.getResource(
