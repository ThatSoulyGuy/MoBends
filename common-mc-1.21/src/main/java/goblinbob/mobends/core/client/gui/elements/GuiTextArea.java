...
import goblinbob.mobends.api.util.ITextFilter;
...
public class GuiTextArea
{
    ...
    {
        String s = "";
        ITextFilter textFilter = ITextFilter.Holder.getFilter();
        String s1 = textFilter != null ? textFilter.filterText(textToWrite) : textToWrite;
        int i = this.cursorPosition < this.selectionEnd ? this.cursorPosition : this.selectionEnd;
        int j = this.cursorPosition < this.selectionEnd ? this.selectionEnd : this.cursorPosition;
    ...
    public boolean charTyped(char typedChar, int modifiers)
    {
        ...
        ITextFilter textFilter = ITextFilter.Holder.getFilter();
        if (textFilter != null && textFilter.isAllowedChatCharacter(typedChar))
        {
            if (this.isEnabled)
            {
