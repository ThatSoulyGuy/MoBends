...
import goblinbob.mobends.lib.math.matrix.Mat4x4d;
import goblinbob.mobends.lib.math.matrix.MatrixUtils;
import goblinbob.mobends.lib.math.vector.IVec3d;
import goblinbob.mobends.lib.math.vector.IVec3dRead;
import goblinbob.mobends.lib.math.vector.IVec4d;
import goblinbob.mobends.lib.math.vector.IVec4dRead;
...
public class TransformUtils
{
	...
	{
		Mat4x4d rotation = Mat4x4d.identity();
