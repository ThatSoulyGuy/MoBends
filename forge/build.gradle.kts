...
loom {
    ...
    forge {
        ...
        mixinConfig("mobends-forge.mixins.json", "mobends-forge-armourers.mixins.json", "mobends-forge-carryon.mixins.json", "mobends-forge-wearablebackpacks.mixins.json", "mobends-forge-iris.mixins.json", "mobends-forge-umapyoi.mixins.json", "mobends-forge-mca.mixins.json", "mobends-forge-legends.mixins.json")
    }
    mixin {
