 ...
 *
 * <p>A SERVER config in Forge lives in the world's {@code serverconfig} folder and is loaded when
 * the world loads, which is why {@link #sync()} is driven from the server-starting event as well
 * as from config load and reload.
 *
