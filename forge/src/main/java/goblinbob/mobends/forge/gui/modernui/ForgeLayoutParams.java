...
/**
 * Forge wrapper for Modern UI LayoutParams.
 */
public class ForgeLayoutParams implements ILayoutParams
{
     ...
     */
    public ForgeLayoutParams(ViewGroup.LayoutParams nativeParams)
    {
     ...
     */
    public ForgeLayoutParams(ViewGroup.LayoutParams nativeParams, IViewFactory factory)
    {
        this.nativeParams = nativeParams;
