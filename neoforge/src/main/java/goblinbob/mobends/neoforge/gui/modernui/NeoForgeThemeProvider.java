...
/**
 * NeoForge 1.21.1 theme provider implementation.
 * Uses Modern UI 3.11.x drawable API with enhanced features.
 */
public class NeoForgeThemeProvider implements IThemeProvider
{
    @Override
    ...
    {
        // Modern UI 3.11.x has better gradient support via GradientShader
        // For simplicity, use a solid color for now
        // A full implementation would use the new Shader APIs
        ShapeDrawable drawable = new ShapeDrawable();
