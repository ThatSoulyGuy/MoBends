...
public class NeoForgeConfig
{
    ...
    public static final ModConfigSpec.BooleanValue MOBS_CAN_SPIN;
    ...
    public static final ModConfigSpec.BooleanValue NEW_ENCHANT_GLINT;

    public static final ModConfigSpec.BooleanValue SWORD_TRAIL_FULL_BRIGHT;
