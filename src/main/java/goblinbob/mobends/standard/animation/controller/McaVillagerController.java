...
public class McaVillagerController implements IAnimationController<McaVillagerData<?>>
{
    ...
    protected final AnimationBit<BipedEntityData<?>> bitWalk =
            new goblinbob.mobends.standard.animation.bit.player.WalkAnimationBit<>();
    protected final AnimationBit<BipedEntityData<?>> bitSprint =
            new goblinbob.mobends.standard.animation.bit.player.SprintAnimationBit<>();
    ...
    protected final AnimationBit<BipedEntityData<?>> bitExternalPose =
            new goblinbob.mobends.standard.animation.bit.player.ExternalPoseAnimationBit();

    protected final BipedActionController actionController = new BipedActionController();

    @Override
    public void perform(McaVillagerData<?> data)
    {
        final LivingEntity entity = data.getEntity();

        if (goblinbob.mobends.compat.ModCompatManager.isExternallyPosed(entity))
        {
